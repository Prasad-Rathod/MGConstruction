const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Professional office and retail space design that enhances productivity.",
    ...
    },
    {
      ...
      description: "Comprehensive lighting solutions that enhance both function and ambiance.",
    ...
    },
    {
      ...
      description: "Curated furniture selection and custom pieces tailored to your style.",
  ...
  const process = [
    ...
    },
    {
      ...
      description: "We refine the design based on your feedback and finalize all project details.",
    },
    {
      step: "04",
    ...
    },
    {
      step: "05",
      title: "Final Reveal",
      description: "We complete the project with final styling and a comprehensive walkthrough.",
    },
  ]
    ...
    <div className="pt-20">
      ...
      <section className="section-padding hero-gradient">
        <div className="container-custom text-center">
          <h1 className="text-5xl lg:text-6xl font-display font-bold text-black mb-6">Our Services</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From initial concept to final installation, we offer comprehensive interior design and construction services
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-display font-bold text-black mb-4">Our Process</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We follow a proven process to ensure every project is completed on time, on budget, and exceeds your
              expectations.
            </p>
          </div>
      ...
      <section className="section-padding bg-black text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let's discuss your project and see how we can bring your vision to life. Contact us today for a free
            consultation.
          </p>
